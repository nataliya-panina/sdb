...
## Решение
```
telnet localhost 11211  # подключение к memcached по протоколу telnet
set name 0 10 5 # Установка ключа name с флагом 0, TTL 10с, длиной 5 бит
sasha # Установка значения ключа
```
